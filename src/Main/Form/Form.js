            ...
            <div className="form_content">
                <div className="form_content_contact">
                    ...
                    <div className="form_contact_social">
                        <a className='contact_social_link' href='https://t.me/mmakssimm'><img src={require('../socials/telegram.png')} alt='' /></a>
                        <a className='contact_social_link' href='https://ru.linkedin.com/'><img src={require('../socials/linkedin.png')} alt='' /></a>
                        <a className='contact_social_link' href='https://maksim-ash.ru'><img src={require('../socials/letter-m.png')} alt='' /></a>
                        <a className='contact_social_link' href='https://github.com/maksimyou'><img src={require('../socials/github.png')} alt='' /></a>
                    </div>
